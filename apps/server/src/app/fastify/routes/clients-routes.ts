import { DeleteClientController, ListClientController, ListTopConsumersControllers, ListTopSpenderController, RegisterClientController, UpdateClientController } from "apps/server/src/api/controllers";
